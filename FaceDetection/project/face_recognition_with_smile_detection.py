...
def detectFace(grayScaledImage, orginalFrame):
	...
	for (x, y, w, h) in faces:
		...
		smiles = smile_cascade.detectMultiScale(regionOfIntrestForGrayScale, 1.7, 22)
		for (smileX, smileY, smileW, smileH) in smiles:
			cv2.rectangle(regionOfIntrestForOrginalColor, (smileX, smileY), (smileX+smileW, smileY+smileH), (0, 0, 255), 2)
